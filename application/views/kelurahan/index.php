<div class="container">
	<div class="row justify-content-center py-3">
		<div class="col-lg header-title">
			<h3><i class="fas fa-fw fa-building"></i> Rukun Warga</h3>
		</div>
		<?php if ($dataUser['jabatan'] == 'administrator'): ?>
			<div class="col-lg header-button">
				<a href="<?= base_url('kelurahan/addKelurahan'); ?>" class="btn btn-primary"><i class="fas fa-fw fa-plus"></i> Tambah Rukun Warga</a>
			</div>
		<?php endif ?>
	</div>
	<div class="row py-3">
				...
				<table class="table table-bordered" id="table_id">
					<thead class="thead-dark">
						<tr>
							...
							<th class="align-middle">Rukun Warga</th>
